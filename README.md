...
## Incomplete features
  ...
  * Freetype support
  ...
  ## New cvars
    * cg_widescreenFOVAdjust 0/1 - enable or disable aspect corrected FoV
    * cg_widescreenUI 0/1/2 - 0 disable widescreen Q3UI, 1 aspect correct Q3UI, 2 clamp UI to 4:3
    * cg_widescreenMenus 0/1/2 - 0 disable widescreen TA scripted menus, 1 aspect correct TA scripted menus, 2 clamp TA scripted menus to 4:3
